---
heroImage: /images/uploads/büttel-tradition.jpg
historyTitle: Unsere Geschichte – Ein Ort mit Tradition
valuesTitle: Unsere Werte
values:
  - icon: <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3
      .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7
      7Z"/>
    title: Gemeinschaft
    description: Wir fördern das Miteinander und den Zusammenhalt aller Generationen
      in unserem Dorf.
  - icon: <circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle
      cx="12" cy="12" r="2"/>
    title: Engagement
    description: >
      Mit ehrenamtlicher Arbeit setzen wir uns aktiv für die Belange von Büttel
      ein.
  - icon: <circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3
      1.523-9.11"/>
    title: Tradition
    description: Wir bewahren und pflegen die Traditionen und Bräuche unseres Dorfes.
  - icon: <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7"
      r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0
      7.75"/>
    title: Offenheit
    description: Jeder ist bei uns willkommen - neue Ideen und Mitglieder sind uns
      herzlich willkommen.
boardTitle: Unser Vorstand
boardMembers:
  - name: Patrick Schalk
    role: 1. Vorsitzender
  - name: Thomas Gloger
...
membershipTitle: Mitglied werden
membershipSubtitle: >-
  Werden Sie Teil unserer Gemeinschaft! 

  Als Mitglied unterstützen Sie unsere Arbeit und können aktiv das Dorfleben mitgestalten.

  Ob jung oder alt - jeder Beitrag, ob passiv oder aktiv zählt
membershipFees:
  - label: pro Haushalt
    price: 10 € / Jahr
---
Büttel wurde erstmals 1105 in einer Urkunde des Bremer Erzbischofs Friedrich als Butli, oder Butle parvum erwähnt und blickt auf eine über 900-jährige Geschichte zurück. Mit dem Zusatz parvum heißt es Klein-Büttel. Die Namengebung rührt von bodila = Hof oder Landgut her, sowie byl, das ist der keltische Name für Hügel. Ort der Sicherheit könnte die freie Übersetzung lauten.

Die St. Marienkirche, erbaut um 1500, steht auf einer historischen Warft und ist ein Zeugnis unserer langen Tradition.

In Büttel hatte man über Jahrhunderte das Kuriosum, dass dieser Ort zweigeteilt war. Der Ortsteil Büttel (ohne ü-Striche) war oldenburgisch und gehörte zu Landwürden, der Ortsteil Büttel, war zunächst stiftisch, d.h. zugehörig zum Erzbistum Bremen, später hannoversch und preußisch und ein selbstständiger Ort. Um 1791wird der Ort mit 17 Häusern nach Büttel und mit 25 Häusern nach Dedesdorf eingepfarrt.
